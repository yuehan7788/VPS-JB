...
show_menu() {
    ...
    echo -e "\033[1;34m========================================\033[0m"
    # 白色标题
    echo -e "\033[1;97m        一键安装脚本合集 v$version\033[0m"
    echo -e "\033[1;34m========================================\033[0m"
    # 红色编号，白色内容
    echo -e "\033[1;31m1.\033[0m \033[1;97m安装 Xray(233boy急速)\033[0m"
    echo -e "\033[1;31m2.\033[0m \033[1;97m安装 八合一键脚本mack-a&(歇斯底里)\033[0m"
    echo -e "\033[1;31m3.\033[0m \033[1;97m安装 FranzKafkaYu/x-ui\033[0m"
    echo -e "\033[1;31m4.\033[0m \033[1;97m安装 kejilong工具\033[0m"
    echo -e "\033[1;31m5.\033[0m \033[1;97m卸载脚本\033[0m"
    echo -e "\033[1;31m6.\033[0m \033[1;97m脚本信息\033[0m"
    echo -e "\033[1;31m7.\033[0m \033[1;97m自动安装 mack-a sing-box Hysteria2\033[0m"
    echo -e "\033[1;31m8.\033[0m \033[1;97m卸载expect工具\033[0m"
    echo -e "\033[1;31m9.\033[0m \033[1;97m一键卸载mack-a sing-box和VPS-JB脚本\033[0m"
    echo -e "\033[1;31m0.\033[0m \033[1;97m退出\033[0m"
    echo -e "\033[1;34m========================================\033[0m"
    # 蓝色提示
    echo -ne "\033[1;36m请输入选项 [0-9]: \033[0m"
}


  # # 渐变色无法直接用ANSI实现，以下为现代美式风格
  # echo -e "\033[1;34m========================================\033[0m"
  # echo -e "\033[1;97m        美式现代一键安装菜单 v$version\033[0m"
  # echo -e "\033[1;34m========================================\033[0m"
  # echo -e "\033[1;31m1.\033[0m \033[1;97m安装 Xray(233boy急速)\033[0m"
  # echo -e "\033[1;36m2.\033[0m \033[1;97m安装 八合一键脚本mack-a&(歇斯底里)\033[0m"
  # echo -e "\033[1;35m3.\033[0m \033[1;97m安装 FranzKafkaYu/x-ui\033[0m"
  # echo -e "\033[1;34m4.\033[0m \033[1;97m安装 kejilong工具\033[0m"
  # echo -e "\033[1;33m5.\033[0m \033[1;97m卸载脚本\033[0m"
  # echo -e "\033[1;32m6.\033[0m \033[1;97m脚本信息\033[0m"
  # echo -e "\033[1;31m0.\033[0m \033[1;97m退出\033[0m"
  # echo -e "\033[1;34m========================================\033[0m"
  # echo -ne "\033[1;36m请选择操作 [0-6]: \033[0m"
